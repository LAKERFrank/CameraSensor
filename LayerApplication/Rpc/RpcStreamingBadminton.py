...
class RpcStreamingBadminton:
    def __init__(self, manager:RpcManager):
        ...
        for idx, agent in self.manager.sensingLayerAgents.items():
            self.sensing_topics[idx] = f'/DATA/{agent.device_name}/LayerSensing/TrackNet'
        ...
        if self.manager.contentLayerAgent:
            self.content_topic_point = f'/DATA/{self.manager.contentLayerAgent.device_name}/LayerContent/Model3D/Point'
            self.content_topic_event = f'/DATA/{self.manager.contentLayerAgent.device_name}/LayerContent/Model3D/Event'
            self.content_topic_segment = f'/DATA/{self.manager.contentLayerAgent.device_name}/LayerContent/Model3D/Segment'
