...
from LayerContent.Rpc_content import RpcContent
...
class ExampleAPP():
    ...
    def on_connect(self, client:mqtt.Client, userdata, flags, reason_code, properties):
        ...
        self.mqttc.subscribe(f"/DATA/cam_0/LayerSensing/TrackNet")
        self.mqttc.subscribe(f"/DATA/cam_1/LayerSensing/TrackNet")
