...
class ExampleAPP():
    ...
    def on_connect(self, client:mqtt.Client, userdata, flags, reason_code, properties):
        ...
        self.mqttc.subscribe(f"/DATA/ContentDevice/LayerContent/Model3D")
        self.mqttc.subscribe(f"/DATA/ContentDevice/LayerContent/Model3D/Event")
        self.mqttc.subscribe(f"/DATA/ContentDevice/LayerContent/Model3D/Segment")
